...
input_csv_path = 'Individual_Landmark_Sites.csv'  
...
output_directory = 'nyc_output_files'
os.makedirs(output_directory, exist_ok=True)

for keyword in keywords:
    keyword_df = df[df['LPC_NAME'].str.contains(keyword, case=False)]
...
other_df = df[~df['LPC_NAME'].str.contains('|'.join(keywords), case=False)]
